...
struct llama_model * go_llama_load_model_from_file(void *params_ptr);
struct llama_context * go_llama_new_context_with_model(struct llama_model * model, void *params_ptr);
